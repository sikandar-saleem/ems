...
class EmploymentsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create employment" do
    assert_difference("Employment.count") do
      post employments_url, params: { employment: { date_ended: @employment.date_ended, date_started: @employment.date_started, employer: @employment.employer } }
    end
  ...
  test "should update employment" do
    patch employment_url(@employment), params: { employment: { date_ended: @employment.date_ended, date_started: @employment.date_started, employer: @employment.employer } }
